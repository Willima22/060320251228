...
DROP POLICY IF EXISTS "Admins can read all assignments" ON survey_assignments;
DROP POLICY IF EXISTS "Admins can insert assignments" ON survey_assignments;
DROP POLICY IF EXISTS "Admins can update assignments" ON survey_assignments;
DROP POLICY IF EXISTS "Admins can delete assignments" ON survey_assignments;
DROP POLICY IF EXISTS "Researchers can read own assignments" ON survey_assignments;
DROP POLICY IF EXISTS "Researchers can update own assignments" ON survey_assignments;

-- Create or replace the survey_assignments table
...
-- Policy for researchers to read their own assignments and related surveys
